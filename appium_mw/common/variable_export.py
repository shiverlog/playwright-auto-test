...
class Variable():
    ...
    def export_excel_variables(self):
        ...
        page_name=['common_el','login_el','mainpage_el','phone_plan_1dep','phone_plan_2dep','iptv_el','mypage','mobile_el','support_el','benefit_el','direct_el','uth_el','udoc_el','search_el']
