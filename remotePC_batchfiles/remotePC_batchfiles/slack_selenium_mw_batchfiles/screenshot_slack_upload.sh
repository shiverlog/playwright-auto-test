...
cd 'C:/dev/remotePC_batchfiles/pubsub/selenium_mw/result/screenshot';
SCREENSHOT=$(cd C:/dev/remotePC_batchfiles/pubsub/selenium_mw/result/screenshot; ls -al | grep ^- | wc -l;)
...
FILE_PREV_URL=C:/dev/remotePC_batchfiles/pubsub/selenium_mw/result/screenshot
...
done > C:/dev/remotePC_batchfiles/slack_selenium_mw_batchfiles/batchfiles_result/step5_screenshot_slack_upload.log 2>&1
