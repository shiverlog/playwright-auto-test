...
# git clone 받은 selenium_pc 파일의  에러 스크린샷 파일 수 가져오기
cd 'C:/dev/remotePC_batchfiles/pubsub/selenium_pc/result/screenshot';
SCREENSHOT=$(cd C:/dev/remotePC_batchfiles/pubsub/selenium_pc/result/screenshot; ls -al | grep ^- | wc -l;)
...
FILE_PREV_URL=C:/dev/remotePC_batchfiles/pubsub/selenium_pc/result/screenshot
...
done > C:/dev/remotePC_batchfiles/slack_selenium_pc_batchfiles/batchfiles_result/step5_screenshot_slack_upload.log 2>&1
